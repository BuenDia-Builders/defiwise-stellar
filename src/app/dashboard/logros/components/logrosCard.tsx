...
export default function LogrosCard({ text, img, href }: LogrosCardProps) {
  return (
    <div className="flex flex-col items-center">
      ...
      {href && (
        <a href={href} className="flex items-center mt-2 underline">
          <span className="mr-[5px]">Ver en Stellar</span>
